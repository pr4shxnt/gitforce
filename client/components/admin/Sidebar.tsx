...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: 'Calendar', href: '/admin/chats/calendar' },
      { name: 'General Meeting', href: '/admin/chats/general-meeting' },
      { name: 'Broadcast Service', href: '/admin/chats/broadcast-service' },
    ],
  },
  {
    name: 'Members',
  ...
  },
  {
    ...
    subItems: [
      { name: 'Projects', href: '/admin/manage/projects' },
      { name: 'Gallery', href: '/admin/manage/gallery' },
      { name: 'Team', href: '/admin/manage/team' },
      { name: 'Content', href: '/admin/manage/content' },
    ],
  },
];
